...
- 法定节假日 / 调休：`Tic/Sources/Holiday/HolidayStore.swift`（仅打包 `Resources/holidays/*.json`，随发版更新；见 [`docs/holiday-data-source.md`](docs/holiday-data-source.md)）
...
- 检查更新：`Tic/Sources/Update/`（每天本地 10:00 自动提醒 + 手动检查，GitHub Releases API，浏览器打开下载页；见 [`docs/app-update.md`](docs/app-update.md)）
...
| 检查更新 | [`docs/app-update.md`](docs/app-update.md) | `Update*`、`UpdateChecker`、发版与客户端更新联动 |
